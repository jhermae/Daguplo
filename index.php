            ...
            <div class="container-fluid aboutDiv" id="about">
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-10" style="padding-left:30px;">
                        ...
                        <p class="aboutInfo"><span class="glyphicon glyphicon-envelope"></span> <b>Mail Us:</b><br> <a href="mailto:futaaspin@gmail.com">futaaspins@gmail.com</a></p>

                        <p class="aboutInfo"><span class="glyphicon glyphicon-phone"></span> <b>Contact Us:</b><br> 09123456789</p>

                        <p class="aboutInfo"><i class="fa fa-facebook-square"></i> <b>Follow Us:</b><br> <a href="http://Facebook.com">Facebook.com/FutaTweets</a></p>
                        <br>
                        <p>FUTA ASPINIANS No.1 Twitter</p>
                        <p>&copy; All Right Reserved@2017 z3r0oo</p>
                    </div>
